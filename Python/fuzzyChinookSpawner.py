...
out_name = "FuzzyChinookSpawner_DVSC.tif"
bfw = 7.34
...
from SupportingFunctions import make_folder, clean_temp_dir, make_raster
import numpy as np
import os
...
def main(
    ...
    fhm_points = chinook_spawner_fis(in_points, bfw)
...
def chinook_spawner_fis(in_points, bfw):
    ...
    velocity_array[velocity_array < 0] = 0
    velocity_array[velocity_array > 4] = 4
    d50_array[d50_array < 0] = 0
    d50_array[d50_array > 4000] = 4000
    cover_array[cover_array < 0] = 0
    ...
    rule4 = ctrl.Rule(d50['cobbleboulder'], suitability['low'])
